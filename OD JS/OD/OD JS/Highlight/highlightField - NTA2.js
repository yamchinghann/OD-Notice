//calculate the
//numberOfEmployer[0].WagesDetailWagesInfo_SubForm.WagesDetailWagesInfo[0]
...
function loopEmployer(dupeDates) {
    ...
    console.log("Number of Employer:" + numberOfEmployer);
    ...
    for (let empNumber = 0; empNumber < numberOfEmployer.length; empNumber++) {
        ...
        console.log("End Month Year: " + endMonthYear);
                    ...
                    if (!!wMV && !!wYV) {
                        ...
                        if (hasMatch(p, monthYear) && dateToCombine != -1) {
                            ...
                            if (employerCount == 1 && j == 0) {
                                ...
                                setFormFieldValue('SimilarWorkerDropdown', 'Yes')
